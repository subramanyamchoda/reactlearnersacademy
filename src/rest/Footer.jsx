...
const Footer = () => {
    return (
        <footer className="text-center text-lg-start text-white fixed-footer" id="footer">
                ...
                <section>
                    <div className="row">
                        ...
                        <div className="col-md-1 col-lg-1 col-xl-1 mx-auto mt-1">
                            ...
                            <p><a className="text-white" href="index.jsp">Home</a></p>
                            <p><a className="text-white" href="about.jsp">About</a></p>
                            <p><a className="text-white" href="login.jsp">Login</a></p>
                        </div>
                        <hr className="w-100 clearfix d-md-none" />
